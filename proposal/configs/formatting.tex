...
\setlength{\lofnumwidth}{5.8em} % Adjust ini buat jarak antara penomoran gambar dengan judul gambar
\newlength{\lotnumwidth}
\setlength{\lotnumwidth}{5.3em} % Adjust ini buat jarak antara penomoran tabel dengan judul tabel
...
\newcommand{\todo}[1]{{\color{todoorange}\textbf{Todo:} #1}}
